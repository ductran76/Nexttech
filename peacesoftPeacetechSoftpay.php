    ...
    <div id="mainHeader" class="headerAbout">   
        ...
        <nav id="subNavi">
            <ul id="subNaviItems">
                ...
                <li class="liSub"><span class="spaceSub"><img src="images/titleline.png" alt=""/></span></li>
                <li class="liSub"><a href="structureSoftpay.php">Softpay intl'</a></li> 
                <li class="liSub"><span class="spaceSub"><img src="images/titleline.png" alt=""/></span></li>
                <li class="liSub active"><a class="active" href="peacesoftPeacetechSoftpay.php">Peacetech JSC</a></li> 
            </ul>
        </nav>
    </div>
</div>
