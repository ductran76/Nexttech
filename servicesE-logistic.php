    ...
    <article id="mainArticle" class="mainAbout">
        <div id="scrollingSection">
            <div id="headerSection">
                <h2 id="titleHeader2" class="titleHeader2">"The lines between everywhere will be blurring by e-Logistic"</h2>
            </div>
            <div id="fullText">
                <div class="listPeople listAbout">
                    <div class="leftAbout">
                        <a href="servicesShipchung.php">
                            <div class="typeAbout">
                                <h3>Shipchung.vn</h3>
                            </div>
                            <br>
    ...
    <div id="mainHeader" class="headerAbout">   
        ...
        <nav id="subNavi">
            <ul id="subNaviItems">
                ...
                <li class="liSub"><span class="spaceSub"><img src="images/titleline.png" alt=""/></span></li>
                <li class="liSub active"><a class="active" href="servicesE-logistic.php">E-logistic</a></li> 
            </ul>
        </nav>
    </div>
</div>
