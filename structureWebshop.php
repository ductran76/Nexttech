...
<div id="content">
    <article id="mainArticle" class="mainAbout">    
        <div id="scrollingSection">
            <div id="headerSection"><h2 id="titleHeader2" class="titleHeader2">"Go global or go home?"</h2></div>
            <div id="fullText">            
    ...
    <div id="mainHeader" class="headerAbout">   
        ...
        <nav id="subNavi">
            <ul id="subNaviItems">
                ...
                <li class="liSub"><span class="spaceSub"><img src="images/titleline.png" alt=""/></span></li>
                <li class="liSub active"><a class="active" href="structureWebshop.php">Weshop intl'</a></li>  
            </ul>
        </nav>
    </div>
</div>
