...
<div id="content">
    <article id="mainArticle" class="mainAbout">
        <div id="scrollingSection">
            <div id="headerSection"><h2 id="titleHeader2" class="titleHeader2">"We are one united group of entrepreneurs who endlessly startup innovative technologies"</h2></div>
            <div id="fullText">            
                <div class="center-image namestructure">
                    <img src="images/peacesoftlogo.png" alt=""/>
                    <br/>
                    <h2>Peacesoft - Group</h2>
                </div>
                ...
                <div class="row structure">
                    <div class='leftStructure'>
                        <a href="peacesoftPeacetech.php">
                            <div class="typestructure">
                                <h3>Peacetech JSC</h3>
                            </div>
                            <br/>
                            <br/>
                            <div class='hoverclick'><img src="images/addbutton/thirdadd-button.png" alt=''/></div>
                            <br/>
                            <div class="liner lineStructure">
                    ...
                    <div class="rightStructure">
                        <a href="peacesoftShipchung.php">
                            <div class="typestructure">
                                <h3>Shipchung</h3>
                            </div>
                            <br/>
    ...
    <div id="mainHeader" class="headerAbout">   
        ...
        <nav id="subNavi">
            <ul id="subNaviItems">
                ...
                <li class="liSub"><span class="spaceSub"><img src="images/titleline.png" alt=""/></span></li>
                <li class="liSub active"><a class="active" href="structurePeacesoft.php">PeaceSoft Group</a></li> 
            </ul>
        </nav>
    </div>
</div>
